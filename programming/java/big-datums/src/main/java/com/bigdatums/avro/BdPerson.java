...
public class BdPerson extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.bigdatums.avro.BdPerson.Builder newBuilder() {
    return new com.bigdatums.avro.BdPerson.Builder();
  }
  
  /** Creates a new BdPerson RecordBuilder by copying an existing Builder */
  public static com.bigdatums.avro.BdPerson.Builder newBuilder(com.bigdatums.avro.BdPerson.Builder other) {
    return new com.bigdatums.avro.BdPerson.Builder(other);
  }
  
  /** Creates a new BdPerson RecordBuilder by copying an existing BdPerson instance */
  public static com.bigdatums.avro.BdPerson.Builder newBuilder(com.bigdatums.avro.BdPerson other) {
    return new com.bigdatums.avro.BdPerson.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BdPerson>
    ...
    private Builder() {
      super(com.bigdatums.avro.BdPerson.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.bigdatums.avro.BdPerson.Builder other) {
      super(other);
    ...
    private Builder(com.bigdatums.avro.BdPerson other) {
            super(com.bigdatums.avro.BdPerson.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public com.bigdatums.avro.BdPerson.Builder setId(int value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearId() {
    ...
    /** Sets the value of the 'username' field */
    public com.bigdatums.avro.BdPerson.Builder setUsername(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearUsername() {
      username = null;
    ...
    /** Sets the value of the 'email_address' field */
    public com.bigdatums.avro.BdPerson.Builder setEmailAddress(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearEmailAddress() {
      email_address = null;
    ...
    /** Sets the value of the 'phone_number' field */
    public com.bigdatums.avro.BdPerson.Builder setPhoneNumber(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearPhoneNumber() {
      phone_number = null;
    ...
    /** Sets the value of the 'first_name' field */
    public com.bigdatums.avro.BdPerson.Builder setFirstName(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearFirstName() {
      first_name = null;
    ...
    /** Sets the value of the 'last_name' field */
    public com.bigdatums.avro.BdPerson.Builder setLastName(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearLastName() {
      last_name = null;
    ...
    /** Sets the value of the 'middle_name' field */
    public com.bigdatums.avro.BdPerson.Builder setMiddleName(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearMiddleName() {
      middle_name = null;
    ...
    /** Sets the value of the 'sex' field */
    public com.bigdatums.avro.BdPerson.Builder setSex(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearSex() {
      sex = null;
    ...
    /** Sets the value of the 'birthdate' field */
    public com.bigdatums.avro.BdPerson.Builder setBirthdate(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearBirthdate() {
      birthdate = null;
    ...
    /** Sets the value of the 'join_date' field */
    public com.bigdatums.avro.BdPerson.Builder setJoinDate(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearJoinDate() {
      join_date = null;
    ...
    /** Sets the value of the 'previous_logins' field */
    public com.bigdatums.avro.BdPerson.Builder setPreviousLogins(java.lang.Integer value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearPreviousLogins() {
    ...
    /** Sets the value of the 'last_ip' field */
    public com.bigdatums.avro.BdPerson.Builder setLastIp(java.lang.CharSequence value) {
    ...
    public com.bigdatums.avro.BdPerson.Builder clearLastIp() {
      last_ip = null;
